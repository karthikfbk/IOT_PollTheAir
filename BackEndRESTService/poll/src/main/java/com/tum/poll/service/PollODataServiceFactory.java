...
public abstract class PollODataServiceFactory extends ODataServiceFactory {
   ...
   * <p>public class JPAReferenceServiceFactory extends PollODataServiceFactory{</p>
   * 
  ...
  public final ODataService createService(final ODataContext ctx) throws ODataException {
    ...
    ODataSingleProcessor odataJPAProcessor = new PollODataJPAProcessor(oDataJPAContext);
