sap.ui.define([
		...
		return BaseObject.extend("poll.the.air.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias poll.the.air.model.ListSelector
			 */
			 ...
			 * @return {poll.the.air.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
