sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("poll/the/air/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("poll.the.air.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["poll/the/air/localService/mockserver"], function (mockserver) {
