			...
			onTheMasterPage : {
							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("Geolocations", {
											Id : sCurrentId
										});
				...
				assertions : {
					...
					theListShouldBeSortedAscendingOnUnitNumber : function () {
						return this.theListShouldBeSortedAscendingOnField("Latitude");
					},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all Geolocations to be able to check for the total amount
